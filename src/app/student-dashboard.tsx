...
import { cardShadow, Fonts } from '@/constants/ui';
...
const styles = StyleSheet.create({
    ...
    avatarText: { color: AppColors.card, fontSize: 16, fontFamily: Fonts.heading },
    headerText: { flex: 1 },
    greeting: { fontSize: 20, color: AppColors.text, fontFamily: Fonts.heading },
    ...
    examStripText: { flex: 1, fontSize: 14, color: AppColors.text, fontFamily: Fonts.bodyBold },
    ...
    heroLabel: {
        fontSize: 12, color: AppColors.accent, fontFamily: Fonts.headingSemi,
        textTransform: 'uppercase', letterSpacing: 0.5,
    },
    heroTitle: { fontSize: 21, color: AppColors.card, marginBottom: 10, fontFamily: Fonts.heading },
    ...
    navigateBtnText: { color: AppColors.primaryDark, fontSize: 15, fontFamily: Fonts.bodyBold },

    section: { marginBottom: 22 },
    sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
    sectionTitle: { fontSize: 17, color: AppColors.text, marginBottom: 12, fontFamily: Fonts.heading },
    sectionLink: { fontSize: 14, color: AppColors.primary, fontFamily: Fonts.bodyBold },
    emptyLine: { fontSize: 14, color: AppColors.mutedText, lineHeight: 20, fontFamily: Fonts.body },
    moreLine: { fontSize: 13, color: AppColors.mutedText, marginTop: 2, fontFamily: Fonts.bodyMedium },

    railRow: { flexDirection: 'row', gap: 12, marginBottom: 12 },
    railTime: { width: 62, paddingTop: 14, alignItems: 'flex-end' },
    railTimeText: { fontSize: 13, color: AppColors.primary, fontFamily: Fonts.bodyBold },
    railCard: {
    ...
    railCourse: { fontSize: 12, color: AppColors.primary, fontFamily: Fonts.bodyBold },
    railTitle: { fontSize: 15, color: AppColors.text, marginBottom: 5, fontFamily: Fonts.headingSemi },
    ...
    iconRowBody: { flex: 1 },
    iconRowTitle: { fontSize: 15, color: AppColors.text, marginBottom: 3, fontFamily: Fonts.headingSemi },
    ...
    gridLabel: { fontSize: 12, color: AppColors.text, textAlign: 'center', fontFamily: Fonts.bodyMedium },
});
